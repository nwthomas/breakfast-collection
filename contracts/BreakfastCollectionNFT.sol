...
contract BreakfastCollectionNFT is ERC721URIStorage {
    ...
    event NewBreakfastCollectionNFTMinted(address sender, uint256 tokenId);
    ...
    constructor() ERC721 ("Breakfast Collection", "Aw yiss") {
    ...
    function makeNFT() public {
        ...
        emit NewBreakfastCollectionNFTMinted(msg.sender, newItemId);
    }
